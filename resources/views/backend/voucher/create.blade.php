                  ...
                  <!-- BEGIN EXAMPLE TABLE PORTLET-->
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-globe"></i>Add Voucher</div>
                            <div class="tools"></div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <form action="{{ url('/admin/vouchers/') }}" method="POST"  enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" id="code_voucher" name="code_voucher">
                                 </div>
                                 <div class="form-group">
                                     <label for="minimum_transaction">Minimum Trasaction ($)</label>
                                     <input type="number" class="form-control" id="minimum_transaction" name="minimum_transaction" step="any">
                                 </div>
                                 <div class="form-group">
