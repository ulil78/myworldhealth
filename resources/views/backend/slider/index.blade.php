                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
            						 <table class="table table-striped table-bordered table-hover" id="sample_2">
                                      ...
                                      <th>Picture</th>
                                      <th>Status</th>
                                      <th> <a href="{{url('admin/sliders/create')}}" class="btn btn-primary">Add Slider</a> </th>
                                    </tr>
                                </thead>
                                <tbody>
                                     {{'', $n=1}}
                                        ...
                                        <td>
                        									  <a href="{{ url('/admin/sliders/'.$item->id.'/edit') }}" class="btn btn-warning">EDIT</a>
                                            <form action="{{ url('admin/sliders/'.$item->id) }}" method="POST">
