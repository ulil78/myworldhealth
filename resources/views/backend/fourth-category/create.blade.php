                  ...
                  <!-- BEGIN EXAMPLE TABLE PORTLET-->
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">Add Fourth Category</div>
                            <div class="tools"></div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <form action="{{ url('/admin/fourth-categories/') }}" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                 ...
                                 <a href="{{ url('/admin/fourth-categories') }}" class="btn btn-danger">Cancel</a>
                            </form>
