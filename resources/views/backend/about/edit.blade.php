                  ...
                  <!-- BEGIN EXAMPLE TABLE PORTLET-->
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-globe"></i>About us</div>
                            <div class="tools"></div>
                        </div>
                            ...
                            <form action="{{ url('/admin/abouts/'.$about->id) }}" method="POST"  enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="_method" value="PUT">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <img height="75" src="{{asset($about->path.$about->filename)}}">
                                     <input type="file" class="form-control" name="picture" value="{{$about->filename}}">
                                 </div>
