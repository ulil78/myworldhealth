                    ...
                    <div class="portlet box default">
                       {{--  <div class="portlet-title">
                        ...
                        <div class="portlet-body">
                          <div class="panel">
                            <a href="{{url('merchant/transfer-arrivals/create')}}" class="btn btn-default">Transfer Arrival</a>
                          </div>
                                            ...
                                            <td>
                                              ...
                                              <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                      <a href="{{ url('/merchant/transfer-arrivals/'.$item->id.'/edit') }}">Edit</a>
                                                    </li>
                                                
                                                  <form id="delete-form-{{$item->id}}"
                                                      method="post"
                                                      action="{{url('merchant/transfer-arrivals/'.$item->id) }}"
                                                      style="display: none;">
                                                      {{csrf_field()}}
                                                      {{method_field('DELETE')}}
                                                  </form>
