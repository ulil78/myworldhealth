                  ...
                  <!-- BEGIN EXAMPLE TABLE PORTLET-->
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-globe"></i>Edit Transfer Return</div>
                        ...
                        <div class="portlet-body">
                            ...
                            <form action="{{ url('/merchant/transfer-returns/'.$transfer->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                 ...
                                 <a href="{{ url('/merchant/transfer-returns') }}" class="btn btn-warning">Cancel</a>
                            </form>
