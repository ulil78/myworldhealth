                  ...
                  <!-- BEGIN EXAMPLE TABLE PORTLET-->
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <form action="{{ url('/merchant/hospitals/'.$hospital->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    @endphp
                                    <input type="text" class="form-control" value="{{$merchant}}" disabled/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <br />
                                 <a href="{{url('merchant/add-image/' .$hospital->id)}}" class="btn btn-success" data-toggle="modal" data-target="#myModal"> <i class="icon-plus"></i> Add Images</a>
                                 <br /><br />
                                    ...
                                    @foreach ($images as $image)
                                      ...
                                      <div class="col-md-3">
                                        <div class="image-box">
                                          ...
                                          <div class="overlay">
                                                <div class="text"><a href="{{url('merchant/remove-image/' .$image->id. '/' .$hospital->id)}}"><i class="icon-trash"></i><br /> Remove</a></div>
                                            </div>
                                        </div>
                                      </div>
                                 ...
                                 <a href="{{ url('/merchant/hospitals') }}" class="btn btn-warning">Cancel</a>
                            </form>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   <div class="modal-dialog" role="document">
     <div class="modal-content">
       ...
       @endif
       <form method="post" action="{{url('merchant/add-image')}}" enctype="multipart/form-data">
          <input type="hidden" name="_token" value="{{csrf_token()}}" />
