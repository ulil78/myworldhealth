...
<body>
                            ...
                            <div class="p-5">
                                <div class="col-md-12 col-12">
                                    <div class="text-center mb-4">
                                        <i class="ion-ios-body" style="font-size: 120px;color: #3399ff;"></i>
                                        <h1 class="h3 mb-3 font-weight-normal">Partner Center</h1>
                                        <p>Manage your company data at MyworldHealth with <br>
                                        <em class="font-weight-bold"> MyworldHealth Partner Center</em> <br>
                                      </div>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="footer">
      <div class="container">
        <small class="text-muted">Partner Center</small> <br>
